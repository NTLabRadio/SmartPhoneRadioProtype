...
private:
	...
	static const uint16_t DEFAULT_TX_FREQ_CHAN	= 640;	//426 МГц	
	static const uint16_t DEFAULT_RX_FREQ_CHAN	= 640;	//426 МГц
	#else
	static const uint16_t DEFAULT_TX_FREQ_CHAN	= 960;	//434 МГц	
	static const uint16_t DEFAULT_RX_FREQ_CHAN	= 960;	//434 МГц
	#endif
